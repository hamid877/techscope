 ...
 */
export const V1_WEIGHT_COMMIT_CADENCE = 0.2;
export const V1_WEIGHT_RELEASE_FREQUENCY = 0.15;
export const V1_WEIGHT_ISSUE_RESOLUTION_HEALTH = 0.2;
export const V1_WEIGHT_CONTRIBUTOR_CONCENTRATION = 0.15;
export const V1_WEIGHT_DOWNLOAD_MOMENTUM = 0.2;
